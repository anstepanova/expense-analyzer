...
target_metadata = DbConstants.BASE.metadata
...
def run_migrations_offline() -> None:
    ...
    output.
    """
    url = str(services_settings.sync_postgres_dsn)
    context.configure(
        url=url,
...
def run_migrations_online() -> None:
    ...
    alembic_config['sqlalchemy.url'] = str(services_settings.sync_postgres_dsn)
